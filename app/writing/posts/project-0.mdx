...
The original marginfi ui was built a while back, long before Project 0 was imagined. During those tumultuous months we moved fast and layered fixes, features, and patches wherever we could. It kept the protocol running, but it left us with fragmented interfaces, inconsistent flows, and a system never designed for what we were asking of it.

With Project 0, patching wasn’t an option, we rebuilt from zero: a new design system, a new application architecture, built around clarity and speed. We weren’t just cleaning up debt, we were redefining how DeFi should operate.
